...
public class Enemy_Basic : MonoBehaviour
{
    ...
    // Loot array
    public Enemy_BasicSpawnLoot[] LootDrops;
    ...
    public void TakeDamage(float amount)
    {
        ...
        if (Health <= 0)
        {
            // kill enemy and add basic money
            Die();
            moneyManager.MoneyAddBasic();
    ...
    public void IncreaseEnemyHealth1()
    {
...
[System.Serializable]
public class Enemy_BasicSpawnLoot
{
    // Loot object
