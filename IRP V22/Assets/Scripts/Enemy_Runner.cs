...
public class Enemy_Runner : MonoBehaviour
{
    ...
    // Loot array
    public Enemy_RunnerPowerupDrops[] LootDrops;
    ...
    public void TakeDamage(float amount)
    {
        ...
        if (Health <= 0)
        {
            ...
            Die();
            moneyManager.MoneyAddMedium();
        }

    }

    // Increase enemy health
    public void IncreaseEnemyHealth2()
    {
...
[System.Serializable]
public class Enemy_RunnerPowerupDrops
{
    // Loot object
